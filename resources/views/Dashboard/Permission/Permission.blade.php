        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Permission
                        </h4>
                            ...
                            <div class="card-datatable table-responsive pt-0">
                                ...
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="w-50 text-end">
                                        <a href="{{ route('add.permission') }}" class="btn btn-primary">
                                            <i class="ti ti-plus me-sm-1"></i>Add Permission
                                        </a>
                                ...
                                <table class="table" id="example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Permission Title</th>
                                                            ...
                                                            $('.item-delete').off('click').on('click', function(
                                                                ...
                                                                Swal.fire({
                                                                    ...
                                                                    if (result.isConfirmed) {
                                                                        $.ajax({
                                                                            url: '{{ route("permission.delete", ":id") }}'.replace(':id', id),
                                                                            method: 'GET',
                                                                            data: {
                                                                                _token: '{{ csrf_token() }}'
                                                                            },
