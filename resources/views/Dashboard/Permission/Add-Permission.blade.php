                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form id="PermissionForm">
                                    ...
                                    <div class="mb-3">
                                        <label for="permission_slug" class="form-label">Permission Slug</label>
                                        <input type="text" class="form-control" name="permission_slug" id="permission_slug" placeholder="Enter User Name" />
                                        <div class="invalid-feedback" id="permission_slug-error"></div>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#PermissionForm').on('submit', function(e) {
            ...
            var permission_slug = $('#permission_slug').val();
            if (permission_slug.trim() === '') {
                $('#permission_slug').addClass('is-invalid');
                $('#permission_slug-error').text('Permission Slug is required');
                isValid = false;
            }
