        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Admins
                        </h4>
                                ...
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="w-50 text-end">
                                        <a href="{{ route('add.admin') }}" class="btn btn-primary">
                                            <i class="ti ti-plus me-sm-1"></i>Add Admin
                                        </a>
                                                ...
                                                success: function(response) {
                                                    ...
                                                    $.each(response.admins, function(key, item) {
                                                        tableData.push([
                                                            ...
                                                            `,
                                                            `<div>
                                                                <a href="/admin/admins/edit/${item.id}" class="btn btn-sm btn-icon item-edit">
                                                    ...
                                                    $('#example').DataTable({
                                                        ...
                                                        drawCallback: function(settings) {
                                                            ...
                                                            $('.item-mail').off('click').on('click', function(
                                                                event) {
                                                                event.preventDefault();
                                                                ...
                                                                Swal.fire({
                                                                    ...
                                                                    if (result.isConfirmed) {
                                                                        ...
                                                                        $.ajax({
                                                                            url: '/admin/admins/send-invitation',
                                                                            method: 'POST',
                                                                            data: {
                                                                                email: email,
                                                                                _token: '{{ csrf_token() }}'
