                            ...
                            <div class="card-body">
                                <form id="UsersForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" value="{{ $new->name }}" placeholder="Enter User Name" />
                                        <div class="invalid-feedback" id="name-error"></div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">User Email</label>
                                        <input type="email" class="form-control" name="email" id="email" value="{{ $new->email }}" placeholder="Enter User Email" />
